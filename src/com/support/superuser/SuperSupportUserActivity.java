...
public class SuperSupportUserActivity extends Activity implements AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_super_support_user);
        getActionBar().setDisplayHomeAsUpEnabled(true);
        lvClientUserList = (ListView)findViewById(R.id.super_super_support_user_list);
        ...
        AsyncCallWS2 as = new AsyncCallWS2(this, "0", String.valueOf(spm.getInt("CompanyID", 0)), "True" );
        as.execute();
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        UserDepartments ud = new UserDepartments(SuperSupportUserActivity.this);
    ...
    public void showPopUpForSupportUsers(final Context mContext, String username, String firstName, String lastName, String email,
        ...
        et6.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if(et6.isEnabled()) {
                    if (!hasFocus) {
                        DoesUserExist does = new DoesUserExist(SuperSupportUserActivity.this);
        ...
        cuAdapter = new UserDepartmentAdapter(this,
                listUserDepts);
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                if(et1.getText().toString().isEmpty() || et2.getText().toString().isEmpty() || et3.getText().toString().isEmpty() ||
                                    ...
                                    Utilities.ShowDialog("Warning!", "Please fill in required fields.", SuperSupportUserActivity.this);
                                } else {
        ...
        protected void onPostExecute(String result) {
            ...
            for (int a = 0; a < listUserDepts.size(); a++) {
                if (listUserDepts.get(a).getIsActive() == 1) {
                    InsertUserDepartment iud = new InsertUserDepartment(SuperSupportUserActivity.this, result,String.valueOf(listUserDepts.get(a).getCommentTypeID()));
                    iud.execute();
                } else {
                    DeleteUserDepartment iud = new DeleteUserDepartment(SuperSupportUserActivity.this, result,String.valueOf(listUserDepts.get(a).getCommentTypeID()));
                    iud.execute();
                }
            }
