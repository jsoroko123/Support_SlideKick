...
public class SuperStatusAdapter extends ArrayAdapter<CaseStatus> implements  DragSortListView.DragSortListener {
    private Context context;
    private ArrayList<CaseStatus> listItemInfos;
    public static EditText etDept;

    public SuperStatusAdapter(Context context, ArrayList<CaseStatus> list) {
    ...
    public View getCustomView(final int position, View convertView, ViewGroup parent) {
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                etDept.clearFocus();
                SuperStatusActivity.listStatuses.remove(position);
